...
<title>Erreur, Page en construction</title>
<style>
    * {
        margin: 0;
        padding: 0
...
<a href={{ route('home') }}><img src="{{ asset('images/golfmaroc.png') }}"> </a>
<p><b>Erreur</b>
    <ins>That’s an error.</ins>
<p>The requested URL <code>/ergfregerge</code> was not found on this server.
