...
@section('main_content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Ajouter au Stock
                    <small></small>
                </h1>
                    ...
                    <!-- Row 1 -->
                                    ...
                                    <select class="form-control" name="id_magasin" autofocus>
                                        @if( !$magasins->isEmpty() )
                                            @foreach( $magasins as $item )
                                                <option value="{{ $item->id_magasin }}" {{ $item->id_magasin == old('id_magasin') ? 'selected' : '' }} > {{ $item->libelle }}
                                                    ()
                                                </option>
                                            @endforeach
                                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" placeholder="Quantite"
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" placeholder="Quantite Min"
                                           name="quantite_min" value="{{ old('quantite_min') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" placeholder="Quantite Max"
                                           name="quantite_max" value="{{ old('quantite_max') }}" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div>
                                ...
                                <button type="submit" name="submit" value="verifier" class="btn btn-default">Vérifier
                                </button>
                                                ...
                                                <ul class="list-group" align="center">
                                                    @foreach($data as $item)
                                                        <li class="list-group-item"><a
                                                                    href="{{ route('direct.info',[ 'p_table' => 'articles' , 'p_id' => $item->id_article ]) }}"
