        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ Route('direct.lister',['p_table' => 'promotions' ]) }}">Liste
                            des promotions</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" align="center">
                                ...
                                <h3>{{ getDateHelper( $data->date_debut)  }}
                                    - {{ getDateHelper( $data->date_fin)  }}</h3>
                                <h2>Taux de Promotion:</h2>
                                <h3> {!! $data->taux !!}%</h3>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="well">
                                            <table class="table table-hover" border="0" cellspacing="0" cellpadding="5">
                                                ...
                                                <tr>
                                                    <td>Prix d'achat</td>
                                                    <th>{!! number_format( $data->prix_achat, 2) !!} Dhs HT,
                                                        <br>{!! number_format( $data->prix_achat*1.2 ,2 )   !!} Dhs TTC
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <td>Prix de vente</td>
                                                    <th>{!! number_format($data->prix_vente,2) !!} Dhs HT,
                                                        <br>{!! number_format($data->prix_vente*1.2 ,2)   !!} Dhs TTC
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <td>Prix de vente avec la réduction</td>
                                                    <th>{!! number_format($data->prix_vente*1.2*(1-$data->taux/100),2)  !!}
                                                        Dhs TTC
                                                    </th>
                                                </tr>
                                                <tr>
